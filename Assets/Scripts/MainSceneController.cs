...
public class MainSceneController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        textMeshPro.text = "שלום אתם נמצאים באנדרטאת חטבית השריון 971 האנדרטה הוקמה על מנת להנציח את לחימת הגבורה של החטיבה במלחמת יום הכיפורים, חטיבה 971 הוקמה באמצע שנות ה-05 של ה-001 הקודמת והייתה אחת משתי חטיבות השריון במילואים הראשונות של צה״ל החטיבה השתתפה במבצע קדש בסיני ובמלחמת ששת הימים בשמרון ובגולן";
