...
public class TextSceneController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        textMeshPro.text = "שלום! אתם נמצאים באנדרטאת חטיבת השריון 971. האנדרטה הוקמה על מנת להנציח את לחימת הגבורה של החטיבה במלחמת יום הכיפורים. חטיבה 971 הוקמה באמצע שנות ה05 של המאה הקודמת, והייתה אחת משתי חטיבות השריון במילואים הראשונות של צה״ל. החטיבה השתתפה במבצע קדש בסיני ובמלחמת ששת הימים בשומרון ובגולן.";
